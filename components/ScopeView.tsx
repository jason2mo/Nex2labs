        ...
        {categories.map((s) => {
          return (
            <button 
              ...
              className="bg-black p-20 py-28 space-y-10 hover:bg-white text-left group transition-all relative overflow-hidden"
            >
              <div>
                <h3 className="text-4xl font-black mb-8 uppercase italic tracking-tighter group-hover:text-black transition-colors leading-[1.1] whitespace-pre-line">
                  {s.title}
                </h3>
                <p className="text-xl font-bold opacity-60 leading-relaxed group-hover:opacity-100 group-hover:text-black transition-colors max-w-[85%]">
                  {s.desc}
                </p>
              </div>
