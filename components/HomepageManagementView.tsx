        ...
        return (
          <div className="space-y-10">
            ...
            <div className="pt-6">
              ...
              <label className="block w-full bg-white/5 border-2 border-dashed border-white/20 py-10 text-center cursor-pointer hover:bg-white/10 transition-all group overflow-hidden relative">
                {homeData.logoImage ? (
        ...
        return (
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <label className="block w-full bg-white/5 border-2 border-dashed border-white/20 aspect-video flex flex-col items-center justify-center cursor-pointer hover:bg-white/10 transition-all relative overflow-hidden group">
                {homeData.heroImage ? (
                  <>
            ...
            <div className="space-y-6 border-b border-white/10 pb-8">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-b border-white/20 p-2 text-sm font-black italic outline-none focus:border-white transition-all" 
                />
              </div>
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-b border-white/20 p-2 text-xs font-bold outline-none focus:border-white transition-all" 
          ...
          <div className="space-y-6">
            <div className="space-y-4 border-b border-white/10 pb-6">
              ...
              <textarea 
                ...
                className="w-full bg-transparent border-b border-white/20 p-2 text-xs h-20 outline-none focus:border-white" 
            ...
            <div className="flex justify-between items-center pt-4">
              ...
              <button onClick={() => updateHomeData({ testimonials: [...homeData.testimonials, { name: '이름', role: '직함', text: '리뷰 내용', avatar: null }] })} className="bg-white text-black px-3 py-1 text-[10px] font-black">ADD</button>
            </div>
            
            <div className="space-y-6">
              {homeData.testimonials.map((t, i) => (
                <div key={i} className="p-6 border border-white/10 space-y-4 bg-white/5 relative group">
                  ...
                  <div className="flex gap-6 items-start">
                    <div className="space-y-2">
                      ...
                      <div className="w-14 h-14 bg-black border border-white/10 relative overflow-hidden flex items-center justify-center">
                        {t.avatar ? (
                  ...
                  <textarea value={t.text} onChange={e => { const list = [...homeData.testimonials]; list[i].text = e.target.value; updateHomeData({ testimonials: list }); }} className="w-full bg-transparent border-b border-white/10 text-[10px] h-20 outline-none" placeholder="리뷰 내용" />
                </div>
              ))}
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <input value={homeData.ctaVideo || ''} onChange={e => updateHomeData({ ctaVideo: e.target.value })} className="w-full bg-transparent border-b border-white/20 p-2 text-[10px]" placeholder="https://example.com/video.mp4" />
              <div className="bg-white/5 border border-white/10 p-4 space-y-2">
                <p className="text-[9px] font-black uppercase tracking-widest text-white/40 flex items-center gap-2"><Video size={12}/> Recommended Video Specs</p>
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-4">
              ...
              {homeData.footerQuickLinks.map((link, i) => (
                <div key={i} className="space-y-2 bg-white/5 p-3 border border-white/10 group">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      ...
                      <input value={link.label} onChange={e => { const list = [...homeData.footerQuickLinks]; list[i].label = e.target.value; updateHomeData({ footerQuickLinks: list }); }} className="w-full bg-transparent text-[10px] font-bold border-b border-white/20 p-1 outline-none focus:border-white" />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[7px] font-black opacity-20 uppercase">URI / Target</label>
                      <input value={link.target} onChange={e => { const list = [...homeData.footerQuickLinks]; list[i].target = e.target.value; updateHomeData({ footerQuickLinks: list }); }} className="w-full bg-transparent text-[10px] font-bold border-b border-white/20 p-1 outline-none focus:border-white" />
                    </div>
                  </div>
                </div>
              ))}
              ...
              {homeData.footerExploreLinks.map((link, i) => (
                <div key={i} className="space-y-2 bg-white/5 p-3 border border-white/10 group">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      <label className="text-[7px] font-black opacity-20 uppercase">Label</label>
                      <input value={link.label} onChange={e => { const list = [...homeData.footerExploreLinks]; list[i].label = e.target.value; updateHomeData({ footerExploreLinks: list }); }} className="w-full bg-transparent text-[10px] font-bold border-b border-white/20 p-1 outline-none focus:border-white" />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[7px] font-black opacity-20 uppercase">URI / Target</label>
                      <input value={link.target} onChange={e => { const list = [...homeData.footerExploreLinks]; list[i].target = e.target.value; updateHomeData({ footerExploreLinks: list }); }} className="w-full bg-transparent text-[10px] font-bold border-b border-white/20 p-1 outline-none focus:border-white" />
                    </div>
                  </div>
                </div>
              ))}
        ...
        return (
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center text-left py-12">
            ...
            <div className="lg:col-span-5 relative hidden lg:block">
               <div className="aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 hero-image-mask relative bg-white/5">
      ...
      case 'scope':
        return (
          <div className="w-full flex flex-col items-start text-left max-w-4xl mx-auto py-20">
            <div className="mb-10 w-full border-b border-white/10 pb-6">
            ...
            <div className="w-full grid grid-cols-2 gap-px bg-white/10 border border-white/10">
      ...
      case 'testimonials':
        return (
          <div className="w-full space-y-6 flex flex-col items-center max-w-2xl mx-auto py-20 text-left">
            ...
            {homeData.testimonials.map((t, i) => (
              <div key={i} className="bg-white/5 border border-white/10 p-10 w-full flex justify-between items-center group">
                ...
                <div className="w-16 h-16 rounded-full overflow-hidden border border-white/20 bg-black flex items-center justify-center shrink-0">
        ...
        <div className="max-h-[65vh] overflow-y-auto custom-scrollbar pr-2 space-y-8">
              ...
              <div className="pt-8 border-t border-white/10 relative">
                ...
                <div className="mt-12 pt-8 border-t border-white/10">
                   <button 
                    ...
                    disabled={isSaving}
                    className="w-full bg-white text-black py-5 font-black text-[11px] uppercase tracking-[0.4em] flex items-center justify-center gap-3 transition-all hover:bg-neutral-200 active:scale-95 disabled:opacity-50"
                   >
          ...
          {activeTab === 'members_mgmt' && (
            <div className="bg-black p-8 brutal-border space-y-12">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea value={homeData.teamHeroTitle} onChange={e => updateHomeData({ teamHeroTitle: e.target.value })} className="w-full bg-transparent border-b border-white/10 text-[12px] font-black h-20 outline-none" />
                  </div>
                  <div>
                    <label className="text-[9px] font-black opacity-30 block mb-1">설명 문구</label>
                    <textarea value={homeData.teamHeroDescription} onChange={e => updateHomeData({ teamHeroDescription: e.target.value })} className="w-full bg-transparent border-b border-white/10 text-[10px] h-24 outline-none" />
                  </div>
                </div>
              </div>
              <div className="space-y-8">
                <div className="flex justify-between items-center border-b border-white/10 pb-4">
                  ...
                  <button onClick={() => setHomeData(prev => ({ ...prev, members: [...prev.members, { id: `m_${Date.now()}`, name: '새 멤버', role: '직함', bio: '소개글', image: null }] }))} className="bg-white text-black px-3 py-1 text-[10px] font-black">ADD_MEMBER</button>
                </div>
                <div className="space-y-6">
                  {homeData.members.map((m, i) => (
                    <div key={m.id} className="p-4 bg-white/5 border border-white/10 group relative space-y-4">
                      ...
                      <input value={m.name} onChange={e => updateMember(m.id, { name: e.target.value })} className="w-full bg-transparent border-b border-white/10 text-[12px] font-black" placeholder="이름" />
                      <input value={m.role} onChange={e => updateMember(m.id, { role: e.target.value })} className="w-full bg-transparent border-b border-white/10 text-[10px] opacity-40 font-bold" placeholder="직함" />
                      <textarea value={m.bio} onChange={e => updateMember(m.id, { bio: e.target.value })} className="w-full bg-transparent border-b border-white/10 text-[10px] h-16 resize-none" placeholder="소개글" />
                      <div>
              ...
              <button onClick={handleManualSave} className="w-full bg-white text-black py-5 font-black text-[11px] uppercase tracking-widest mt-8">멤버 설정 저장하기</button>
            </div>
          )}
              ...
              <div className="bg-black p-8 brutal-border space-y-6">
                 ...
                 <div className="space-y-4">
                   <div>
                     ...
                     <select value={newPost.category} onChange={e => setNewPost({...newPost, category: e.target.value})} className="w-full bg-black border border-white/20 p-3 text-[11px] font-bold outline-none text-white">
                       <option value="">카테고리를 선택하세요</option>
                       {scopeCategories.map(c => <option key={c.id} value={c.id}>{c.title}</option>)}
                     </select>
                   </div>
                   <input placeholder="포스트 제목" value={newPost.title} onChange={e => setNewPost({...newPost, title: e.target.value})} className="w-full bg-transparent border-b border-white/20 py-2 text-xs font-bold" />
                   <textarea placeholder="포스트 내용" value={newPost.content} onChange={e => setNewPost({...newPost, content: e.target.value})} className="w-full bg-transparent border-b border-white/20 py-2 text-xs h-32" />
                   <div className="space-y-2">
                   ...
                   <button onClick={handleSavePost} className="w-full bg-white text-black py-4 font-black text-xs uppercase tracking-widest hover:bg-neutral-200">포스트 저장</button>
                 </div>
              </div>
              <div className="bg-black p-8 brutal-border space-y-6">
