...
const ContactView: React.FC<ContactViewProps> = ({ onSendInquiry }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-24 animate-fade-in py-12 text-black">
      <div className="text-center space-y-8">
        <h2 className="editorial-title text-7xl italic">CONTACT_US.</h2>
        <p className="text-[11px] font-black uppercase tracking-[0.7em] opacity-40 text-black">비즈니스 협업 및 시스템 구축 문의</p>
      </div>

      <div className="bg-black p-16 text-[#FAF9F6] brutal-border brutal-shadow">
        <form className="space-y-12" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-3">
              ...
              <input 
                ...
                className="w-full bg-transparent border-b-4 border-[#FAF9F6] py-4 font-black text-xl outline-none focus:border-[#FAF9F6]/50 transition-all placeholder:opacity-20" 
          ...
          <div className="space-y-3">
            ...
            <textarea 
              ...
              className="w-full bg-transparent border-b-4 border-[#FAF9F6] py-4 font-black text-xl h-40 resize-none outline-none focus:border-[#FAF9F6]/50 transition-all placeholder:opacity-20" 
              placeholder="구축하고자 하는 시스템에 대해 간략히 기술해 주세요" 
            />
          </div>
          <button type="submit" className="w-full bg-[#FAF9F6] text-black py-6 font-black text-sm uppercase tracking-[0.6em] hover:bg-neutral-200 transition-all active:scale-[0.98]">문의 등록하기</button>
        </form>
      </div>
