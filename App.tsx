      ...
      <nav className="bg-[#FAF9F6] border-b border-black/20 sticky top-0 z-50 px-4 md:px-10 h-20 md:h-24 flex justify-between items-center">
        <div className="flex items-center gap-4 md:gap-12 h-full">
          <button 
            ...
            className="px-2 py-2"
          >
             <img src={homeData.logoImage || '/logo.png'} className="h-8 md:h-10 max-w-[140px] md:max-w-[180px] w-auto object-contain object-left" alt={homeData.brandName} style={{ mixBlendMode: 'multiply' }} />
          </button>
